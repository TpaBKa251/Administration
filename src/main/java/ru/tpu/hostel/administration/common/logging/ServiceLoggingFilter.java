package ru.tpu.hostel.administration.common.logging;
...
import static ru.tpu.hostel.administration.common.logging.Message.FINISH_SERVICE_METHOD_EXECUTION;
import static ru.tpu.hostel.administration.common.logging.Message.FINISH_SERVICE_METHOD_EXECUTION_WITH_RESULT;
import static ru.tpu.hostel.administration.common.logging.Message.SERVICE_METHOD_EXECUTION_EXCEPTION;
import static ru.tpu.hostel.administration.common.logging.Message.START_SERVICE_METHOD_EXECUTION;
import static ru.tpu.hostel.administration.common.logging.Message.START_SERVICE_METHOD_EXECUTION_WITH_PARAMETERS;
import static ru.tpu.hostel.administration.common.util.TimeUtil.getLocalDateTimeStingFromMillis;
...
public class ServiceLoggingFilter {
    ...
    @Around("execution(public * ru.tpu.hostel.administration.service..*(..)) && !execution(* *..ApplicationRunner.*(..))")
